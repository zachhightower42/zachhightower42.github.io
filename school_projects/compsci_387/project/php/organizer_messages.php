...
<body>
    <header>
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><button name="sendMessageForm" class="action-btn" onclick="toggleSendAdminMessageDiv();">Send Message To Admins</button></li>
            ...
            <table class="events-table">
                ...
                <tbody id="workersTableBody">
                    <?php
                        require 'read.php'; 
                        session_start();
                        $messages = readOrganizerMessages($_SESSION['OrganizerID']);
                        foreach ($messages as $message) {
                            if ($message['Worker_ID'] != null) {
    ...
    <div>
        <div id="sendAdminMessageForm" style="display: none;background-color: #12284C;padding: 10px;max-width: 600px;margin: 0 auto;border-radius: 25px;">
                <form method="post" action="organizer_manage_messages.php" style="text-align: center;">
                    ...
                    <input 
                        ...
                        required />
                    <input type="hidden" name="OrganizerToAdminMsg" value="true">
        ...
        <div id="sendWorkerMessageForm" style="display: none;background-color: #12284C;padding: 10px;max-width: 600px;margin: 0 auto;border-radius: 25px;">
                <form method="post" action="organizer_manage_messages.php" style="text-align: center;">
                    ...
                    <input 
                        ...
                        placeholder="Write your message here..." 
                        required />
                    <input type="hidden" name="OrganizerToWorkerMsg" value="true">
                    <button type="submit" class="action-btn">Send</button>
                </form>
        </div>
    </div>
